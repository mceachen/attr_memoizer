...
describe AttrMemoized do
  ...
  class Target
    ...
    attr_memoized :thing, :already_defined_field
    attr_memoized :one_more_thing
  ...
  it "works for fields defined after attr_memoized" do
    t = Target.new
    t.thing.must_equal "thing1"
    t.thing.must_equal "thing1"
  end

  it "works for multiple calls to attr_memoized" do
    t = Target.new
